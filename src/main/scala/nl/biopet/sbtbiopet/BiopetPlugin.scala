...
import com.typesafe.sbt.site.SitePlugin.autoImport.{siteDirectory, siteSubdirName, makeSite}
...
import com.typesafe.sbt.sbtghpages.GhpagesPlugin.autoImport.{ghpagesRepository,ghpagesCleanSite,ghpagesPushSite}
...
object BiopetPlugin extends AutoPlugin {
  ...
  import autoImport._
    ...
    Seq(
      ...
      // Jar assembly
      mainClass in assembly := Some(s"nl.biopet.${name.value.toLowerCase()}.${name.value}"),
